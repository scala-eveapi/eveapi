...
case class Eveapi(currentTime: String,
  result: eveapi.xml.corp.AccountBalance.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.corp.AccountBalance.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.corp.AccountBalance.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
