...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val ServerStatusEveapiFormat: scalaxb.XMLFormat[
      eveapi.xml.server.ServerStatus.Eveapi] = new DefaultServerStatusEveapiFormat {}
  implicit lazy val ServerStatusResultFormat: scalaxb.XMLFormat[
      eveapi.xml.server.ServerStatus.Result] = new DefaultServerStatusResultFormat {}
  ...
  trait DefaultServerStatusEveapiFormat
    ...
    def parser(node: scala.xml.Node,
               stack: List[scalaxb.ElemName]): Parser[eveapi.xml.server.ServerStatus.Eveapi] =
      phrase(
    ...
    override def writesAttribute(__obj: eveapi.xml.server.ServerStatus.Eveapi,
    ...
    def writesChildNodes(__obj: eveapi.xml.server.ServerStatus.Eveapi,
  ...
  trait DefaultServerStatusResultFormat
    ...
    def parser(node: scala.xml.Node,
               stack: List[scalaxb.ElemName]): Parser[eveapi.xml.server.ServerStatus.Result] =
      phrase(
    ...
    def writesChildNodes(__obj: eveapi.xml.server.ServerStatus.Result,
                         __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
