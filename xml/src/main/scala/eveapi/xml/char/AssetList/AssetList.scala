...
case class Eveapi(currentTime: String,
  result: eveapi.xml.char.AssetList.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.char.AssetList.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.char.AssetList.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
...
case class Row(rowset: Option[eveapi.xml.char.AssetList.Rowset] = None,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
