...
package eveapi.xml.account.char.MarketOrder
...
/**
usage:
val obj = scalaxb.fromXML[eveapi.xml.account.char.MarketOrder.Foo](node)
val document = scalaxb.toXML[eveapi.xml.account.char.MarketOrder.Foo](obj, "foo", eveapi.xml.account.char.MarketOrder.defaultScope)
**/
...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val MarketOrderEveapiFormat: scalaxb.XMLFormat[eveapi.xml.account.char.MarketOrder.Eveapi] = new DefaultMarketOrderEveapiFormat {}
  implicit lazy val MarketOrderResultFormat: scalaxb.XMLFormat[eveapi.xml.account.char.MarketOrder.Result] = new DefaultMarketOrderResultFormat {}
  implicit lazy val MarketOrderRowsetFormat: scalaxb.XMLFormat[eveapi.xml.account.char.MarketOrder.Rowset] = new DefaultMarketOrderRowsetFormat {}
  implicit lazy val MarketOrderRowFormat: scalaxb.XMLFormat[eveapi.xml.account.char.MarketOrder.Row] = new DefaultMarketOrderRowFormat {}

  trait DefaultMarketOrderEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.MarketOrder.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.MarketOrder.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.account.char.MarketOrder.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.account.char.MarketOrder.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.MarketOrder.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.MarketOrder.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.account.char.MarketOrder.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultMarketOrderResultFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.MarketOrder.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.MarketOrder.Result] =
      phrase((scalaxb.ElemName(None, "rowset")) ^^
      { case p1 =>
      eveapi.xml.account.char.MarketOrder.Result(scalaxb.fromXML[eveapi.xml.account.char.MarketOrder.Rowset](p1, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.account.char.MarketOrder.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (scalaxb.toXML[eveapi.xml.account.char.MarketOrder.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultMarketOrderRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.MarketOrder.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.MarketOrder.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.account.char.MarketOrder.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.account.char.MarketOrder.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.MarketOrder.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.MarketOrder.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.account.char.MarketOrder.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultMarketOrderRowFormat extends scalaxb.XMLFormat[eveapi.xml.account.char.MarketOrder.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.account.char.MarketOrder.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.account.char.MarketOrder.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.account.char.MarketOrder.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.MarketOrder.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.MarketOrder.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
