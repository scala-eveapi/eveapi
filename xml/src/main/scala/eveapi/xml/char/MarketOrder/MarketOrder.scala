...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.char.MarketOrder.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.account.char.MarketOrder.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.char.MarketOrder.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
