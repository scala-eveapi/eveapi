...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  trait DefaultAccountBalanceEveapiFormat
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.char.AccountBalance.Eveapi] =
      phrase(
  ...
  trait DefaultAccountBalanceResultFormat
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.char.AccountBalance.Result] =
      phrase(
  ...
  trait DefaultAccountBalanceRowsetFormat
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.char.AccountBalance.Rowset] =
  ...
  trait DefaultAccountBalanceRowFormat
    ...
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName])
      : Either[String, eveapi.xml.char.AccountBalance.Row] = seq match {
      case node: scala.xml.Node =>
        Right(eveapi.xml.char.AccountBalance
              .Row(
    ...
    override def writesAttribute(
      ...
      __obj.attributes.toList map {
        case ("@accountID", _) =>
          attr = scala.xml.Attribute(
              null, "accountID", __obj.accountID.toString, attr)
        case ("@accountKey", _) =>
          attr = scala.xml.Attribute(
              null, "accountKey", __obj.accountKey.toString, attr)
        case ("@balance", _) =>
          attr =
            scala.xml.Attribute(null, "balance", __obj.balance.toString, attr)
        case (key, x) =>
          attr = scala.xml.Attribute(
              (x.namespace map { __scope.getPrefix(_) }).orNull,
              x.key.orNull,
