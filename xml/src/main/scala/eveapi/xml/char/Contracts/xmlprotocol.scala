...
package eveapi.xml.char.Contracts
...
/**
usage:
val obj = scalaxb.fromXML[eveapi.xml.char.Contracts.Foo](node)
val document = scalaxb.toXML[eveapi.xml.char.Contracts.Foo](obj, "foo", eveapi.xml.char.Contracts.defaultScope)
**/
...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val ContractsEveapiFormat: scalaxb.XMLFormat[eveapi.xml.char.Contracts.Eveapi] = new DefaultContractsEveapiFormat {}
  implicit lazy val ContractsResultFormat: scalaxb.XMLFormat[eveapi.xml.char.Contracts.Result] = new DefaultContractsResultFormat {}
  implicit lazy val ContractsRowsetFormat: scalaxb.XMLFormat[eveapi.xml.char.Contracts.Rowset] = new DefaultContractsRowsetFormat {}
  implicit lazy val ContractsRowFormat: scalaxb.XMLFormat[eveapi.xml.char.Contracts.Row] = new DefaultContractsRowFormat {}

  trait DefaultContractsEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.char.Contracts.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.Contracts.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.char.Contracts.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.char.Contracts.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.char.Contracts.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.Contracts.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.char.Contracts.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultContractsResultFormat extends scalaxb.ElemNameParser[eveapi.xml.char.Contracts.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.Contracts.Result] =
      phrase((scalaxb.ElemName(None, "rowset")) ^^
      { case p1 =>
      eveapi.xml.char.Contracts.Result(scalaxb.fromXML[eveapi.xml.char.Contracts.Rowset](p1, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.char.Contracts.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (scalaxb.toXML[eveapi.xml.char.Contracts.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultContractsRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.char.Contracts.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.Contracts.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.char.Contracts.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.char.Contracts.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.char.Contracts.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.Contracts.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.char.Contracts.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultContractsRowFormat extends scalaxb.XMLFormat[eveapi.xml.char.Contracts.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.char.Contracts.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.char.Contracts.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.char.Contracts.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.char.Contracts.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.Contracts.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
