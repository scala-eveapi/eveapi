...
case class Eveapi(currentTime: String,
  result: eveapi.xml.char.Contracts.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.char.Contracts.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.char.Contracts.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
