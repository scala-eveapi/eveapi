...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.char.KillMails.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.account.char.KillMails.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.char.KillMails.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
...
case class Row(victim: Option[eveapi.xml.account.char.KillMails.Victim] = None,
  rowset: Option[eveapi.xml.account.char.KillMails.Rowset] = None,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
