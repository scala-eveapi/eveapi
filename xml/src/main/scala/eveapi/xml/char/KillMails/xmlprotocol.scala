...
/**
usage:
val obj = scalaxb.fromXML[eveapi.xml.char.KillMails.Foo](node)
val document = scalaxb.toXML[eveapi.xml.char.KillMails.Foo](obj, "foo", eveapi.xml.char.KillMails.defaultScope)
**/
...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val KillMailsEveapiFormat: scalaxb.XMLFormat[eveapi.xml.char.KillMails.Eveapi] = new DefaultKillMailsEveapiFormat {}
  implicit lazy val KillMailsResultFormat: scalaxb.XMLFormat[eveapi.xml.char.KillMails.Result] = new DefaultKillMailsResultFormat {}
  implicit lazy val KillMailsRowsetFormat: scalaxb.XMLFormat[eveapi.xml.char.KillMails.Rowset] = new DefaultKillMailsRowsetFormat {}
  implicit lazy val KillMailsRowFormat: scalaxb.XMLFormat[eveapi.xml.char.KillMails.Row] = new DefaultKillMailsRowFormat {}
  implicit lazy val KillMailsVictimFormat: scalaxb.XMLFormat[eveapi.xml.char.KillMails.Victim] = new DefaultKillMailsVictimFormat {}

  trait DefaultKillMailsEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.char.KillMails.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.KillMails.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.char.KillMails.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.char.KillMails.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.char.KillMails.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.KillMails.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.char.KillMails.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultKillMailsResultFormat extends scalaxb.ElemNameParser[eveapi.xml.char.KillMails.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.KillMails.Result] =
      phrase((scalaxb.ElemName(None, "rowset")) ^^
      { case p1 =>
      eveapi.xml.char.KillMails.Result(scalaxb.fromXML[eveapi.xml.char.KillMails.Rowset](p1, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.char.KillMails.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (scalaxb.toXML[eveapi.xml.char.KillMails.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultKillMailsRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.char.KillMails.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.KillMails.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.char.KillMails.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.char.KillMails.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.char.KillMails.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.KillMails.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.char.KillMails.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultKillMailsRowFormat extends scalaxb.ElemNameParser[eveapi.xml.char.KillMails.Row] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.char.KillMails.Row] =
      phrase(opt(scalaxb.ElemName(None, "victim")) ~ 
      opt(scalaxb.ElemName(None, "rowset")) ^^
      { case p1 ~ p2 =>
      eveapi.xml.char.KillMails.Row(p1.headOption map { scalaxb.fromXML[eveapi.xml.char.KillMails.Victim](_, scalaxb.ElemName(node) :: stack) },
        p2.headOption map { scalaxb.fromXML[eveapi.xml.char.KillMails.Rowset](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.char.KillMails.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.KillMails.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(__obj.victim map { scalaxb.toXML[eveapi.xml.char.KillMails.Victim](_, None, Some("victim"), __scope, false) } getOrElse {Nil},
        __obj.rowset map { scalaxb.toXML[eveapi.xml.char.KillMails.Rowset](_, None, Some("rowset"), __scope, false) } getOrElse {Nil})

  }

  trait DefaultKillMailsVictimFormat extends scalaxb.XMLFormat[eveapi.xml.char.KillMails.Victim] with scalaxb.CanWriteChildNodes[eveapi.xml.char.KillMails.Victim] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.char.KillMails.Victim] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.char.KillMails.Victim(scala.collection.immutable.ListMap(List(
        (node \ "@allianceID").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[BigInt](x, scalaxb.ElemName(node) :: stack)) } map { "@allianceID" -> _ },
        (node \ "@allianceName").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@allianceName" -> _ },
        (node \ "@characterID").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[BigInt](x, scalaxb.ElemName(node) :: stack)) } map { "@characterID" -> _ },
        (node \ "@characterName").headOption map { x => scalaxb.DataRecord(x, node, scalaxb.fromXML[String](x, scalaxb.ElemName(node) :: stack)) } map { "@characterName" -> _ },
    ...
    override def writesAttribute(__obj: eveapi.xml.char.KillMails.Victim, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.char.KillMails.Victim, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
