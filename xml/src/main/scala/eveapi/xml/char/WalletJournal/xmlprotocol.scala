...
/**
usage:
val obj = scalaxb.fromXML[eveapi.xml.account.char.WalletJournal.Foo](node)
val document = scalaxb.toXML[eveapi.xml.account.char.WalletJournal.Foo](obj, "foo", eveapi.xml.account.char.WalletJournal.defaultScope)
**/
...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val WalletJournalEveapiFormat: scalaxb.XMLFormat[eveapi.xml.account.char.WalletJournal.Eveapi] = new DefaultWalletJournalEveapiFormat {}
  implicit lazy val WalletJournalResultFormat: scalaxb.XMLFormat[eveapi.xml.account.char.WalletJournal.Result] = new DefaultWalletJournalResultFormat {}
  implicit lazy val WalletJournalRowsetFormat: scalaxb.XMLFormat[eveapi.xml.account.char.WalletJournal.Rowset] = new DefaultWalletJournalRowsetFormat {}
  implicit lazy val WalletJournalRowFormat: scalaxb.XMLFormat[eveapi.xml.account.char.WalletJournal.Row] = new DefaultWalletJournalRowFormat {}

  trait DefaultWalletJournalEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.WalletJournal.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.WalletJournal.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.account.char.WalletJournal.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.account.char.WalletJournal.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.WalletJournal.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.WalletJournal.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.account.char.WalletJournal.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultWalletJournalResultFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.WalletJournal.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.WalletJournal.Result] =
      phrase((scalaxb.ElemName(None, "rowset")) ^^
      { case p1 =>
      eveapi.xml.account.char.WalletJournal.Result(scalaxb.fromXML[eveapi.xml.account.char.WalletJournal.Rowset](p1, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.account.char.WalletJournal.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (scalaxb.toXML[eveapi.xml.account.char.WalletJournal.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultWalletJournalRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.account.char.WalletJournal.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.WalletJournal.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.account.char.WalletJournal.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.account.char.WalletJournal.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.WalletJournal.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.WalletJournal.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.account.char.WalletJournal.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultWalletJournalRowFormat extends scalaxb.XMLFormat[eveapi.xml.account.char.WalletJournal.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.account.char.WalletJournal.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.account.char.WalletJournal.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.account.char.WalletJournal.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.WalletJournal.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.WalletJournal.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
