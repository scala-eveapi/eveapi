...
case class Eveapi(currentTime: String,
                  result: eveapi.xml.account.char.MailBodies.Result,
                  cachedUntil: String,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
  lazy val version = attributes("@version").as[BigInt]
}

case class Result(rowset: eveapi.xml.account.char.MailBodies.Rowset)

case class Rowset(row: eveapi.xml.account.char.MailBodies.Row,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
