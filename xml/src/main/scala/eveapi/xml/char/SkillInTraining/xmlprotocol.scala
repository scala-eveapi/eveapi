...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val SkillInTrainingEveapiFormat: scalaxb.XMLFormat[
      eveapi.xml.account.char.SkillInTraining.Eveapi] = new DefaultSkillInTrainingEveapiFormat {}
  implicit lazy val SkillInTrainingResultFormat: scalaxb.XMLFormat[
      eveapi.xml.account.char.SkillInTraining.Result] = new DefaultSkillInTrainingResultFormat {}
  implicit lazy val SkillInTrainingCurrentTQTimeFormat: scalaxb.XMLFormat[
      eveapi.xml.account.char.SkillInTraining.CurrentTQTime] =
    new DefaultSkillInTrainingCurrentTQTimeFormat {}

  trait DefaultSkillInTrainingEveapiFormat
      extends scalaxb.ElemNameParser[eveapi.xml.account.char.SkillInTraining.Eveapi] {
    val targetNamespace: Option[String] = None

    def parser(
      node: scala.xml.Node,
      stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.SkillInTraining.Eveapi] =
      phrase(
          (scalaxb.ElemName(None, "currentTime")) ~
          (scalaxb.ElemName(None, "result")) ~
          (scalaxb.ElemName(None, "cachedUntil")) ^^ {
        case p1 ~ p2 ~ p3 =>
          eveapi.xml.account.char.SkillInTraining.Eveapi(
              scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
              scalaxb.fromXML[eveapi.xml.account.char.SkillInTraining.Result](
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.SkillInTraining.Eveapi,
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.SkillInTraining.Eveapi,
      ...
      Seq.concat(
          ...
          scalaxb.toXML[eveapi.xml.account.char.SkillInTraining.Result](
  ...
  trait DefaultSkillInTrainingResultFormat
      extends scalaxb.ElemNameParser[eveapi.xml.account.char.SkillInTraining.Result] {
    val targetNamespace: Option[String] = None

    def parser(
      node: scala.xml.Node,
      stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.char.SkillInTraining.Result] =
      phrase(
        ...
        case p1 ~ p2 ~ p3 ~ p4 ~ p5 ~ p6 ~ p7 ~ p8 =>
          eveapi.xml.account.char.SkillInTraining.Result(
              scalaxb.fromXML[eveapi.xml.account.char.SkillInTraining.CurrentTQTime](
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.SkillInTraining.Result,
                         __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[eveapi.xml.account.char.SkillInTraining.CurrentTQTime](
                     __obj.currentTQTime, None, Some("currentTQTime"), __scope, false),
                 scalaxb.toXML[String](
                     __obj.trainingEndTime, None, Some("trainingEndTime"), __scope, false),
                 scalaxb.toXML[String](
                     __obj.trainingStartTime, None, Some("trainingStartTime"), __scope, false),
                 scalaxb.toXML[BigInt](
                     __obj.trainingTypeID, None, Some("trainingTypeID"), __scope, false),
                 scalaxb.toXML[BigInt](
                     __obj.trainingStartSP, None, Some("trainingStartSP"), __scope, false),
                 scalaxb.toXML[BigInt](__obj.trainingDestinationSP,
                                       ...
                                       false),
                 scalaxb.toXML[BigInt](
                     __obj.trainingToLevel, None, Some("trainingToLevel"), __scope, false),
                 scalaxb.toXML[BigInt](
                     __obj.skillInTraining, None, Some("skillInTraining"), __scope, false))
  }

  trait DefaultSkillInTrainingCurrentTQTimeFormat
      extends scalaxb.ElemNameParser[eveapi.xml.account.char.SkillInTraining.CurrentTQTime] {
    val targetNamespace: Option[String] = None

    override def isMixed: Boolean = true

    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.account.char.SkillInTraining.CurrentTQTime] =
      phrase(
          optTextRecord ^^ {
        case p1 =>
          eveapi.xml.account.char.SkillInTraining.CurrentTQTime(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.char.SkillInTraining.CurrentTQTime,
                                 __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@offset", _) =>
    ...
    def writesChildNodes(__obj: eveapi.xml.account.char.SkillInTraining.CurrentTQTime,
                         __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
