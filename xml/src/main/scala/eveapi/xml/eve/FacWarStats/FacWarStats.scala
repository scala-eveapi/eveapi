...
case class Eveapi(currentTime: String,
                  result: eveapi.xml.eve.FacWarStats.Result,
                  cachedUntil: String,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
  lazy val version = attributes("@version").as[BigInt]
}

case class Result(totals: eveapi.xml.eve.FacWarStats.Totals,
                  rowset: Seq[eveapi.xml.eve.FacWarStats.Rowset] = Nil)
...
case class Rowset(row: Seq[eveapi.xml.eve.FacWarStats.Row] = Nil,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
