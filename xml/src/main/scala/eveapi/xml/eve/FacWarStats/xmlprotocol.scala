...
/**
usage:
val obj = scalaxb.fromXML[eveapi.xml.account.eve.FacWarStats.Foo](node)
val document = scalaxb.toXML[eveapi.xml.account.eve.FacWarStats.Foo](obj, "foo", eveapi.xml.account.eve.FacWarStats.defaultScope)
**/
...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val FacWarStatsEveapiFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Eveapi] = new DefaultFacWarStatsEveapiFormat {}
  implicit lazy val FacWarStatsResultFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Result] = new DefaultFacWarStatsResultFormat {}
  implicit lazy val FacWarStatsTotalsFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Totals] = new DefaultFacWarStatsTotalsFormat {}
  implicit lazy val FacWarStatsRowsetFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Rowset] = new DefaultFacWarStatsRowsetFormat {}
  implicit lazy val FacWarStatsRowFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Row] = new DefaultFacWarStatsRowFormat {}

  trait DefaultFacWarStatsEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.FacWarStats.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.FacWarStats.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.account.eve.FacWarStats.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.account.eve.FacWarStats.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.FacWarStats.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.FacWarStats.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.account.eve.FacWarStats.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultFacWarStatsResultFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.FacWarStats.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.FacWarStats.Result] =
      phrase((scalaxb.ElemName(None, "totals")) ~ 
      safeRep(scalaxb.ElemName(None, "rowset")) ^^
      { case p1 ~ p2 =>
      eveapi.xml.account.eve.FacWarStats.Result(scalaxb.fromXML[eveapi.xml.account.eve.FacWarStats.Totals](p1, scalaxb.ElemName(node) :: stack),
        p2.toSeq map { scalaxb.fromXML[eveapi.xml.account.eve.FacWarStats.Rowset](_, scalaxb.ElemName(node) :: stack) }) })
    
    def writesChildNodes(__obj: eveapi.xml.account.eve.FacWarStats.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[eveapi.xml.account.eve.FacWarStats.Totals](__obj.totals, None, Some("totals"), __scope, false),
        __obj.rowset flatMap { scalaxb.toXML[eveapi.xml.account.eve.FacWarStats.Rowset](_, None, Some("rowset"), __scope, false) })

  }

  trait DefaultFacWarStatsTotalsFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.FacWarStats.Totals] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.FacWarStats.Totals] =
      ...
      eveapi.xml.account.eve.FacWarStats.Totals(scalaxb.fromXML[BigInt](p1, scalaxb.ElemName(node) :: stack),
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.FacWarStats.Totals, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
  ...
  trait DefaultFacWarStatsRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.FacWarStats.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.FacWarStats.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.account.eve.FacWarStats.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.account.eve.FacWarStats.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.FacWarStats.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.FacWarStats.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.account.eve.FacWarStats.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultFacWarStatsRowFormat extends scalaxb.XMLFormat[eveapi.xml.account.eve.FacWarStats.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.account.eve.FacWarStats.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.account.eve.FacWarStats.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.account.eve.FacWarStats.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.FacWarStats.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.FacWarStats.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
