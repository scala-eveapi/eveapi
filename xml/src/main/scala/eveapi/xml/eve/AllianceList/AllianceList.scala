...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.eve.AllianceList.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.account.eve.AllianceList.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.eve.AllianceList.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
...
case class Row(rowset: Option[eveapi.xml.account.eve.AllianceList.Rowset] = None,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
