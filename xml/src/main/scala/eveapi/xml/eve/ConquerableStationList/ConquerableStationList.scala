...
case class Eveapi(currentTime: String,
                  result: eveapi.xml.account.eve.ConquerableStationList.Result,
                  cachedUntil: String,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
  lazy val version = attributes("@version").as[BigInt]
}

case class Result(rowset: eveapi.xml.account.eve.ConquerableStationList.Rowset)

case class Rowset(row: Seq[eveapi.xml.account.eve.ConquerableStationList.Row] = Nil,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
