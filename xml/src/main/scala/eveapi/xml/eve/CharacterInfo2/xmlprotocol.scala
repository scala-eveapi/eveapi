...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val CharacterInfo2EveapiFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Eveapi] = new DefaultCharacterInfo2EveapiFormat {}
  implicit lazy val CharacterInfo2ResultFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Result] = new DefaultCharacterInfo2ResultFormat {}
  implicit lazy val CharacterInfo2RowsetFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Rowset] = new DefaultCharacterInfo2RowsetFormat {}
  implicit lazy val CharacterInfo2RowFormat: scalaxb.XMLFormat[eveapi.xml.eve.CharacterInfo2.Row] =
    new DefaultCharacterInfo2RowFormat {}

  trait DefaultCharacterInfo2EveapiFormat
      extends scalaxb.ElemNameParser[eveapi.xml.eve.CharacterInfo2.Eveapi] {
    val targetNamespace: Option[String] = None

    def parser(node: scala.xml.Node,
               stack: List[scalaxb.ElemName]): Parser[eveapi.xml.eve.CharacterInfo2.Eveapi] =
      phrase(
          (scalaxb.ElemName(None, "currentTime")) ~
          (scalaxb.ElemName(None, "result")) ~
          (scalaxb.ElemName(None, "cachedUntil")) ^^ {
        case p1 ~ p2 ~ p3 =>
          eveapi.xml.eve.CharacterInfo2.Eveapi(
              scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
              scalaxb.fromXML[eveapi.xml.eve.CharacterInfo2.Result](
    ...
    override def writesAttribute(__obj: eveapi.xml.eve.CharacterInfo2.Eveapi,
    ...
    def writesChildNodes(__obj: eveapi.xml.eve.CharacterInfo2.Eveapi,
      ...
      Seq.concat(
          ...
          scalaxb.toXML[eveapi.xml.eve.CharacterInfo2.Result](
  ...
  trait DefaultCharacterInfo2ResultFormat
      extends scalaxb.ElemNameParser[eveapi.xml.eve.CharacterInfo2.Result] {
    val targetNamespace: Option[String] = None

    def parser(node: scala.xml.Node,
               stack: List[scalaxb.ElemName]): Parser[eveapi.xml.eve.CharacterInfo2.Result] =
      phrase(
        ...
        case p1 ~ p2 ~ p3 ~ p4 ~ p5 ~ p6 ~ p7 ~ p8 ~ p9 ~ p10 ~ p11 ~ p12 =>
          eveapi.xml.eve.CharacterInfo2.Result(scalaxb
                                                 .fromXML[BigInt](
                                               ...
                                               scalaxb
                                                 .fromXML[eveapi.xml.eve.CharacterInfo2.Rowset](
                                                   p12, scalaxb.ElemName(node) :: stack))
      })

    def writesChildNodes(
      __obj: eveapi.xml.eve.CharacterInfo2.Result,
      ...
      Seq.concat(
          ...
          scalaxb.toXML[String](__obj.characterName,
                ...
                scalaxb.toXML[BigDecimal](__obj.securityStatus,
                                          ...
                                          __scope,
                                          false),
                scalaxb.toXML[eveapi.xml.eve.CharacterInfo2.Rowset](
                    __obj.rowset, None, Some("rowset"), __scope, false))
  }

  trait DefaultCharacterInfo2RowsetFormat
      extends scalaxb.ElemNameParser[eveapi.xml.eve.CharacterInfo2.Rowset] {
    val targetNamespace: Option[String] = None

    def parser(node: scala.xml.Node,
               stack: List[scalaxb.ElemName]): Parser[eveapi.xml.eve.CharacterInfo2.Rowset] =
      phrase(
          safeRep(scalaxb.ElemName(None, "row")) ^^ {
        case p1 =>
          eveapi.xml.eve.CharacterInfo2.Rowset(p1.toSeq map {
            scalaxb.fromXML[eveapi.xml.eve.CharacterInfo2.Row](_, scalaxb.ElemName(node) :: stack)
    ...
    override def writesAttribute(__obj: eveapi.xml.eve.CharacterInfo2.Rowset,
                                 __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@columns", _) =>
    ...
    def writesChildNodes(__obj: eveapi.xml.eve.CharacterInfo2.Rowset,
                         __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap {
            scalaxb.toXML[eveapi.xml.eve.CharacterInfo2.Row](_, None, Some("row"), __scope, false)
          })
  }

  trait DefaultCharacterInfo2RowFormat
      extends scalaxb.XMLFormat[eveapi.xml.eve.CharacterInfo2.Row]
      with scalaxb.CanWriteChildNodes[eveapi.xml.eve.CharacterInfo2.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._

    def reads(seq: scala.xml.NodeSeq,
              stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.eve.CharacterInfo2.Row] =
      seq match {
        case node: scala.xml.Node =>
          Right(eveapi.xml.eve.CharacterInfo2.Row(scala.collection.immutable
                    .ListMap(
                      List(
    ...
    override def writesAttribute(__obj: eveapi.xml.eve.CharacterInfo2.Row,
                                 __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.eve.CharacterInfo2.Row,
                         __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
  }
}
