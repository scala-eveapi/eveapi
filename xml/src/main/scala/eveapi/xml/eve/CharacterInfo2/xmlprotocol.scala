...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val CharacterInfo2EveapiFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo2.Eveapi] = new DefaultCharacterInfo2EveapiFormat {}
  implicit lazy val CharacterInfo2ResultFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo2.Result] = new DefaultCharacterInfo2ResultFormat {}
  implicit lazy val CharacterInfo2RowsetFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo2.Rowset] = new DefaultCharacterInfo2RowsetFormat {}
  implicit lazy val CharacterInfo2RowFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo2.Row] = new DefaultCharacterInfo2RowFormat {}

  trait DefaultCharacterInfo2EveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo2.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo2.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.account.eve.CharacterInfo2.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo2.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo2.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo2.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo2.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultCharacterInfo2ResultFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo2.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo2.Result] =
      ...
      eveapi.xml.account.eve.CharacterInfo2.Result(scalaxb.fromXML[BigInt](p1, scalaxb.ElemName(node) :: stack),
        ...
        scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo2.Rowset](p12, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo2.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[BigInt](__obj.characterID, None, Some("characterID"), __scope, false),
        ...
        scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo2.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultCharacterInfo2RowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo2.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo2.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.account.eve.CharacterInfo2.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo2.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo2.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo2.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo2.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultCharacterInfo2RowFormat extends scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo2.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.account.eve.CharacterInfo2.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.account.eve.CharacterInfo2.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.account.eve.CharacterInfo2.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo2.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo2.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
