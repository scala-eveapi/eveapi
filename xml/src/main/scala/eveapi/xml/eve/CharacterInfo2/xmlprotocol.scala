...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val CharacterInfo2EveapiFormat: scalaxb.XMLFormat[
    ...
    new DefaultCharacterInfo2EveapiFormat {}
  implicit lazy val CharacterInfo2ResultFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Result] =
    new DefaultCharacterInfo2ResultFormat {}
  implicit lazy val CharacterInfo2RowsetFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Rowset] =
    new DefaultCharacterInfo2RowsetFormat {}
  implicit lazy val CharacterInfo2RowFormat: scalaxb.XMLFormat[
      eveapi.xml.eve.CharacterInfo2.Row] =
  ...
  trait DefaultCharacterInfo2EveapiFormat
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.eve.CharacterInfo2.Eveapi] =
      phrase(
    ...
    override def writesAttribute(
        __obj: eveapi.xml.eve.CharacterInfo2.Eveapi,
  ...
  trait DefaultCharacterInfo2ResultFormat
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName])
      : Parser[eveapi.xml.eve.CharacterInfo2.Result] =
      phrase(
        ...
        case p1 ~ p2 ~ p3 ~ p4 ~ p5 ~ p6 ~ p7 ~ p8 ~ p9 ~ p10 ~ p11 ~ p12 =>
          eveapi.xml.eve.CharacterInfo2
            .Result(scalaxb
                      .fromXML[BigInt](p1, scalaxb.ElemName(node) :: stack),
                    scalaxb.fromXML[String](
                        p2, scalaxb.ElemName(node) :: stack),
                    scalaxb
                      .fromXML[String](p3, scalaxb.ElemName(node) :: stack),
                    scalaxb
                    ...
                    scalaxb.fromXML[String](p10,
                                            scalaxb.ElemName(node) :: stack),
                    scalaxb.fromXML[BigDecimal](
                        p11, scalaxb.ElemName(node) :: stack),
                    scalaxb.fromXML[eveapi.xml.eve.CharacterInfo2.Rowset](
  ...
  trait DefaultCharacterInfo2RowsetFormat
    ...
    def parser(
        node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[
        eveapi.xml.eve.CharacterInfo2.Rowset] =
      phrase(
        ...
        case p1 =>
          eveapi.xml.eve.CharacterInfo2.Rowset(p1.toSeq map {
            scalaxb
              .fromXML[eveapi.xml.eve.CharacterInfo2.Row](_,
                                                          scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(
        __obj: eveapi.xml.eve.CharacterInfo2.Rowset,
        __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
        case ("@columns", _) =>
    ...
    def writesChildNodes(
        ...
        __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap {
            scalaxb.toXML[eveapi.xml.eve.CharacterInfo2.Row](
  ...
  trait DefaultCharacterInfo2RowFormat
    ...
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName])
      : Either[String, eveapi.xml.eve.CharacterInfo2.Row] = seq match {
      case node: scala.xml.Node =>
        Right(eveapi.xml.eve.CharacterInfo2
              .Row(
    ...
    override def writesAttribute(
        __obj: eveapi.xml.eve.CharacterInfo2.Row,
        __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData = scala.xml.Null
      __obj.attributes.toList map {
