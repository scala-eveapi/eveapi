...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.eve.CharacterAffiliation.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.account.eve.CharacterAffiliation.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.eve.CharacterAffiliation.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
