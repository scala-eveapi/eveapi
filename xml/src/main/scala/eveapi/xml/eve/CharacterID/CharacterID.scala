...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.eve.CharacterID.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.account.eve.CharacterID.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.eve.CharacterID.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
