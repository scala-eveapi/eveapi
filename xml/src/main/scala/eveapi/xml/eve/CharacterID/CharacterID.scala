...
case class Eveapi(currentTime: String,
  result: eveapi.xml.eve.CharacterID.Result,
  cachedUntil: String,
...
case class Result(rowset: eveapi.xml.eve.CharacterID.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.eve.CharacterID.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
