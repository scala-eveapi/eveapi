...
case class Eveapi(currentTime: String,
  result: eveapi.xml.account.eve.CharacterInfo.Result,
  cachedUntil: String,
...
case class Result(characterID: BigInt,
  ...
  rowset: eveapi.xml.account.eve.CharacterInfo.Rowset)
      


case class Rowset(row: Seq[eveapi.xml.account.eve.CharacterInfo.Row] = Nil,
  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
