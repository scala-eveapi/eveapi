...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  implicit lazy val CharacterInfoEveapiFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo.Eveapi] = new DefaultCharacterInfoEveapiFormat {}
  implicit lazy val CharacterInfoResultFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo.Result] = new DefaultCharacterInfoResultFormat {}
  implicit lazy val CharacterInfoRowsetFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo.Rowset] = new DefaultCharacterInfoRowsetFormat {}
  implicit lazy val CharacterInfoRowFormat: scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo.Row] = new DefaultCharacterInfoRowFormat {}

  trait DefaultCharacterInfoEveapiFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo.Eveapi] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo.Eveapi] =
      phrase((scalaxb.ElemName(None, "currentTime")) ~ 
      (scalaxb.ElemName(None, "result")) ~ 
      (scalaxb.ElemName(None, "cachedUntil")) ^^
      { case p1 ~ p2 ~ p3 =>
      eveapi.xml.account.eve.CharacterInfo.Eveapi(scalaxb.fromXML[String](p1, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo.Result](p2, scalaxb.ElemName(node) :: stack),
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo.Eveapi, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo.Eveapi, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[String](__obj.currentTime, None, Some("currentTime"), __scope, false),
        scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo.Result](__obj.result, None, Some("result"), __scope, false),
        scalaxb.toXML[String](__obj.cachedUntil, None, Some("cachedUntil"), __scope, false))

  }

  trait DefaultCharacterInfoResultFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo.Result] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo.Result] =
      ...
      eveapi.xml.account.eve.CharacterInfo.Result(scalaxb.fromXML[BigInt](p1, scalaxb.ElemName(node) :: stack),
        ...
        scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo.Rowset](p15, scalaxb.ElemName(node) :: stack)) })
    
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo.Result, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[BigInt](__obj.characterID, None, Some("characterID"), __scope, false),
        ...
        scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo.Rowset](__obj.rowset, None, Some("rowset"), __scope, false))

  }

  trait DefaultCharacterInfoRowsetFormat extends scalaxb.ElemNameParser[eveapi.xml.account.eve.CharacterInfo.Rowset] {
    val targetNamespace: Option[String] = None
    
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[eveapi.xml.account.eve.CharacterInfo.Rowset] =
      phrase(safeRep(scalaxb.ElemName(None, "row")) ^^
      { case p1 =>
      eveapi.xml.account.eve.CharacterInfo.Rowset(p1.toSeq map { scalaxb.fromXML[eveapi.xml.account.eve.CharacterInfo.Row](_, scalaxb.ElemName(node) :: stack) },
        scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo.Rowset, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo.Rowset, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      (__obj.row flatMap { scalaxb.toXML[eveapi.xml.account.eve.CharacterInfo.Row](_, None, Some("row"), __scope, false) })

  }

  trait DefaultCharacterInfoRowFormat extends scalaxb.XMLFormat[eveapi.xml.account.eve.CharacterInfo.Row] with scalaxb.CanWriteChildNodes[eveapi.xml.account.eve.CharacterInfo.Row] {
    val targetNamespace: Option[String] = None
    import scalaxb.ElemName._
    
    def reads(seq: scala.xml.NodeSeq, stack: List[scalaxb.ElemName]): Either[String, eveapi.xml.account.eve.CharacterInfo.Row] = seq match {
      case node: scala.xml.Node => Right(eveapi.xml.account.eve.CharacterInfo.Row(scala.collection.immutable.ListMap(List(
    ...
    override def writesAttribute(__obj: eveapi.xml.account.eve.CharacterInfo.Row, __scope: scala.xml.NamespaceBinding): scala.xml.MetaData = {
      var attr: scala.xml.MetaData  = scala.xml.Null
      __obj.attributes.toList map {
    ...
    def writesChildNodes(__obj: eveapi.xml.account.eve.CharacterInfo.Row, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Nil
