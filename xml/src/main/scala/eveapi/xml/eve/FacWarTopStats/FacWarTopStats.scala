...
case class Eveapi(currentTime: String,
                  result: eveapi.xml.account.eve.FacWarTopStats.Result,
                  cachedUntil: String,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
  lazy val version = attributes("@version").as[BigInt]
}

case class Result(characters: eveapi.xml.account.eve.FacWarTopStats.Characters,
                  corporations: eveapi.xml.account.eve.FacWarTopStats.Corporations,
                  factions: eveapi.xml.account.eve.FacWarTopStats.Factions)

case class Characters(rowset: eveapi.xml.account.eve.FacWarTopStats.Rowset*)

case class Corporations(rowset: eveapi.xml.account.eve.FacWarTopStats.Rowset*)

case class Factions(rowset: eveapi.xml.account.eve.FacWarTopStats.Rowset*)

case class Rowset(row: Seq[eveapi.xml.account.eve.FacWarTopStats.Row] = Nil,
                  attributes: Map[String, scalaxb.DataRecord[Any]] = Map()) {
